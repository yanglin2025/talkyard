...
trait UserDao {
  ...
  /**
   * Update user's password hash without validation.
   * Used for migrating passwords to a new hash format.
   * Does not check password strength since we're migrating existing validated passwords.
   */
